...
public class Model extends JPanel implements ActionListener {
	...
	private void checkMaze() {
		...
		if (finished) {
			...
			// Prüft ob die Anzahl der Ghost weniger sind, als die max Anzahl der
			// Ghost...wenn ja erweitere die Ghosts

			if (N_GHOSTS < MAX_GHOSTS) {
				N_GHOSTS++;
			}
			// Prüft ob der aktuelle Speed weniger ist, als der max Speed...wenn ja
			// erweitere den Speed
			if (currentSpeed < maxSpeed) {
				currentSpeed++;
			} // nach dem das Spiel gewonnen wurde, kommt die Meldung, dass man sich auf das
				// nächste Spiel vorbereiten soll
			initLevel();
	...
	// Prüft ob noch genug leben vorhanden ist, wenn nicht ist das Spiel zu Ende
	private void death() {
